...
## Corpus Check
- 125 files · ~66,895 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 619 nodes · 973 edges · 62 communities (52 shown, 10 thin omitted)
...
### Community 0 - "MlMatch"
Cohesion: 0.07
Nodes (20): CompetitionSetup, Game, MlMatch, Player, PlayerGameStat, Stage, Team, TournamentAward (+12 more)
...
Cohesion: 0.04
Nodes (29): activeDateTab, activeGameNumber, adminTab, currentGroup, editMatchForm, editPlayerForm, editTeamForm, gameDuration (+21 more)
...
## Knowledge Gaps
- **202 isolated node(s):** `$schema`, `name`, `type`, `description`, `laravel` (+197 more)
